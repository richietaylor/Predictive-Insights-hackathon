...
train_data.drop(columns=['Additional_lang', 'Home_lang', 'Science', 'Math', 'Mathlit'], inplace=True)
...
train_data['Schoolquintile'] = knn_imputer.fit_transform(train_data['Schoolquintile'].values.reshape(-1, 1))
...
# Continue with the rest of the cleaning, training, and prediction for training data
...
test_data.drop(columns=['Additional_lang', 'Home_lang', 'Science', 'Math', 'Mathlit'], inplace=True)
...
test_data['Schoolquintile'] = knn_imputer.transform(test_data['Schoolquintile'].values.reshape(-1, 1))
